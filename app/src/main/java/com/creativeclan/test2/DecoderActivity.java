...
public class DecoderActivity extends AppCompatActivity
    implements OnRequestPermissionsResultCallback, OnQRCodeReadListener {
    ...
    if (ActivityCompat.checkSelfPermission(this, Manifest.permission.CAMERA)
      ...
      button.setOnClickListener(new View.OnClickListener() {
          ...
          public void onClick(View v) {
              Intent play=new Intent(DecoderActivity.this,Display.class);

            play.putExtra("resultTextView", resultTextView.getText().toString());
            startActivity(play);
            DecoderActivity.this.startActivity(play);
          }
      });
  }
